...
export class DashboardComponent implements OnInit {
  ...
  getHaftaninEnCokSatanUrunleri() {
    this.http
      .get<any[]>('http://127.0.0.1:5000/haftanin_en_cok_satan_urunleri')
      .subscribe((data) => {
  ...
  getGununEnCokSatanUrunu() {
    this.http
      .get<any>('http://127.0.0.1:5000/gunun_en_cok_satan_urunu')
      .subscribe((data) => {
  ...
  getHaftalikToplamSiparisSayisi() {
    this.http
      .get<any>('http://127.0.0.1:5000/haftalik_toplam_siparis_sayisi')
      .subscribe((data) => {
  ...
  getGunlukToplamSiparisSayisi() {
    this.http
      .get<any>('http://127.0.0.1:5000/gunluk_toplam_siparis_sayisi')
      .subscribe((data) => {
  ...
  getGunlukToplamKargolananSiparisSayisi() {
    this.http
      .get<any>('http://127.0.0.1:5000/gunluk_toplam_kargolanan_siparis_sayisi')
      .subscribe((data) => {
  ...
  getHaftalikToplamSatisSayisi() {
    this.http
      .get<any>('http://127.0.0.1:5000/haftalik_toplam_satis_sayisi')
      .subscribe((data) => {
  ...
  getGunlukToplamSatisSayisi() {
    this.http
      .get<any>('http://127.0.0.1:5000/gunluk_toplam_satis_sayisi')
      .subscribe((data) => {
  ...
  getHaftalikToplamCiro() {
    this.http
      .get<any>('http://127.0.0.1:5000/haftalik_toplam_ciro')
      .subscribe((data) => {
  ...
  getGunlukToplamCiro() {
    this.http
      .get<any>('http://127.0.0.1:5000/gunluk_toplam_ciro')
      .subscribe((data) => {
  ...
  getDünSatısVeri() {
    this.http
      .get<any>('http://localhost:5000/dün-yapılan-satışlar-grafiği')
      .subscribe((data) => {
  ...
  getBugünSatısVeri() {
    this.http
      .get<any>('http://localhost:5000/bugün-yapılan-satışlar-grafiği')
      .subscribe((data) => {
        for (const veri of data) {
